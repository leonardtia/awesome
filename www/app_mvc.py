...
import conf.config
from www.ORM.models import User,Comment,Blog
import www.ORM.orm as orm
from www.coroweb import get,post,add_routes,add_static
from aiohttp import web

loop = asyncio.get_event_loop()
db_conf = conf.config.configs.get('db')

async def looger_factory(app,handler):
...
async def init(loop):
    ...
    app = web.Application(loop=loop,middlewares=[
        looger_factory,response_factory
    ])
